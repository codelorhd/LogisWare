...
import { action_editLeaveType, fetchLeaveType, action_createLeaveType } from "../../../actions";

let item_id = 0;
class EditLeaveTypes extends Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(fetchLeaveType(item_id, this.props.dispatch));
    }
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        leave_type: state.leaveReducers.leave_type,
